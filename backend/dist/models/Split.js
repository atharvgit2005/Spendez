...
const SplitSchema = new mongoose_1.Schema({
    expenseId: { type: mongoose_1.Schema.Types.ObjectId, ref: 'Expense', required: true },
...
(0, mongoose_helpers_1.addIdVirtual)(SplitSchema);
exports.Split = mongoose_1.default.model('Split', SplitSchema);
